<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AboutUs.aspx.cs" Inherits="MCAFoods.AboutUs" %>
  ...
  <div style="background-image: url(img/cook.jpg);  ">
    ...
    <div class="banner">
      <div class="container">
        <div class="header">
          <div class="logo">
           <a href="Home.aspx"><img  src="pictures\logo.jpg" style="width:60px" class="rounded-circle"/></a>
          </div>
	...
	<section class="inter-section spad">
		<div class="container">
			<div class="section-title">
				<i style="color: green;" class="flaticon-019-rib"></i>
				<h2>About us</h2>
			</div>
			<div class="row">
				<div class="col-md-6">
					<p>MCA est un restaurant marocain localisé à Marrakech Gueliz crée le 12 Mars 2018. Parmi
					ses activités principales : Préparer des bons et sanitaires plats marocains, français, thaïlandais et
					japonais, donner une expérience de qualité aux visiteurs. 
					</p>
				</div>
				<div class="col-md-6">
					<p>MCA.ma s’adresse aux habitants du Maroc Marrakech,
					Il va contenir une tache d’inscription dont laquelle le visiteur doit remplir un formulaire (Nom,
					prénom, numéro de téléphone, email, adresse) qui va ajouter ses informations à la base de
					données automatiquement. Cette tache donne l’accès au client pour pouvoir commander et
					payer à la livraison.</p>
				</div>
			</div>
		</div>
	</section>
...
<section class="history" id="history" >
  <div style=" background:url(img/parallax1.jpg) fixed no-repeat center center;">
    ...
    <div class="mu-title">
              ...
              <h5 style="color: green; font-size: 32px; padding-top: 29px;">Histoire</h5>
            </div>
...
<!-- Services section -->
  <section class="services-section spad">
    <div class="container">
      <div class="section-title">
        <i  style="color: green;" class="flaticon-022-tray"></i>
        <h2>Notre Services</h2>
      </div>
      <div class="row services">
        <div class="col-lg-3 col-md-6 service-item">
          <i style="color: green;" class="flaticon-005-coffee-1"></i>
          <h3>Boisson</h3>
          
        </div>
        <div class="col-lg-3 col-md-6 service-item">
          <i style="color: green;" class="flaticon-016-pancake"></i>
          <h3>Dessert</h3>
        
        </div>
        <div class="col-lg-3 col-md-6 service-item">
          <i style="color: green;" class="flaticon-008-soup"></i>
          <h3>Plat Chaud</h3>
          
        </div>
        <div class="col-lg-3 col-md-6 service-item">
          <i style="color: green;" class="flaticon-032-hamburger"></i>
          <h3>Plats préférés</h3>
  ...
  <!-- Services section end -->
	...
	<section class="testimonials-section spad pb-0 set-bg" data-setbg="img/review-bg.jpg">
		<div class="container">
			<div class="section-title text-white">
				...
				<h2>Meilleurs Avis</h2>
			</div>
			<div class="testimonials-slider owl-carousel">
				<div class="ts-item text-white">
					<div class="quota">“</div>
					<p style="font-size: 19px; color: white;">Super service. Concept au point. Produit de Qualité , En effet J'ai découvert les sushi...  J'adore le concept, un très bon exemple de la transformation digitale de la restauration au Maroc Vraiment excellent
          </p>
					<h2><span>Ahmed El Idrissi </span> , Client</h2>
				</div>
				<div class="ts-item text-white">
					<div class="quota">“</div>
					<p style="font-size: 19px; color: white;">Magnifique. Hygiène rien à dire , Livraison dans 30 minutes , Peut-être un peu plus de quantité</p>
					<h2><span>Nour Esahel </span> , Cliente</h2>
				</div>
				<div class="ts-item text-white">
					<div class="quota">“</div>
					<p style="font-size: 19px;color: white;">Excellent service, je le recommande !</p>
					<h2><span>Asil Abiri </span> , Cliente</h2>
				</div>
			</div>
		</div>
	</section>
    ...
    <footer class="footer-content">
        <div class="layer footer">
           ...
           <a href="index.html"><img  src="pictures\logo.jpg" style="width:50px ; float: left;" class=" rounded-circle"/></a>
